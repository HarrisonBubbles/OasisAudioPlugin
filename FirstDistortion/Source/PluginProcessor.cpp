...
//==============================================================================
const juce::String FirstDistortionAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool FirstDistortionAudioProcessor::acceptsMidi() const
{
...
bool FirstDistortionAudioProcessor::producesMidi() const
{
...
bool FirstDistortionAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double FirstDistortionAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int FirstDistortionAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int FirstDistortionAudioProcessor::getCurrentProgram()
{
    return 0;
}

void FirstDistortionAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String FirstDistortionAudioProcessor::getProgramName (int index)
{
    return {};
}

void FirstDistortionAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void FirstDistortionAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    // Use this method as the place to do any pre-playback
    // initialisation that you need..
}

void FirstDistortionAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool FirstDistortionAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void FirstDistortionAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool FirstDistortionAudioProcessor::hasEditor() const
{
...
//==============================================================================
void FirstDistortionAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
{
    return new FirstDistortionAudioProcessor();
}

float FirstDistortionAudioProcessor::getRmsValue(const int channel) const
{
